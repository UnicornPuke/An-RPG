...
def sheep():
    ...
    if shtep == 1 or shtep == 2 or shtep == 43:
        enemy.maxhp = rat.maxhp
        enemy.hp = rat.hp
        enemy.attack = rat.attack
        enemy.defense = rat.defense
        enemy.magic = rat.magic
        enemy.luck = rat.luck
        jeep = "Aaah! It's a rat, hope he doesn't cook some cheese!"
        combat()
        ...
        enemy.maxhp = grass_monster.maxhp
        enemy.hp = grass_monster.hp
        enemy.attack = grass_monster.attack
        enemy.defense = grass_monster.defense
        enemy.magic = grass_monster.magic
        enemy.luck = grass_monster.luck
        ...
        enemy.maxhp = dirt_monster.maxhp
        enemy.hp = dirt_monster.hp
        enemy.attack = dirt_monster.attack
        enemy.defense = dirt_monster.defense
        enemy.magic = dirt_monster.magic
        enemy.luck = dirt_monster.luck
        ...
        enemy.maxhp = goblin.maxhp
        enemy.hp = goblin.hp
        enemy.attack = goblin.attack
        enemy.defense = goblin.defense
        enemy.magic = goblin.magic
        enemy.luck = goblin.luck
        ...
        eep = "You drink some healing water and feel holy all of a sudden."
        player.hp = player.maxhp
        shlep = input(jeep)
        if shlep == "stats":
            stats()
        ...
        jeep = "You pick your paycheck at work."
        shlep = input(jeep)
        money += 15
        if shlep == "stats":
            stats()
